    ...
    <div className="p-6 max-w-7xl mx-auto">
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 text-sm">Immutable record of all data access and changes · NDPR compliance</p>
        </div>
        <a
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-gray-100 bg-gray-50">
                    ...
                    <th className="text-left px-4 py-3 text-xs font-semibold text-gray-500">Resource ID</th>
      ...
      <div className="mt-6 p-4 bg-gray-50 rounded-xl border border-gray-200">
        <p className="text-sm font-medium text-gray-700 mb-3">CSV Exports</p>
